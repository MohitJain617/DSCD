...
class WriteResponse(_message.Message):
    __slots__ = ["content", "name", "status", "uuid", "version"]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    UUID_FIELD_NUMBER: _ClassVar[int]
    ...
    uuid: str
    version: str
    def __init__(self, status: _Optional[str] = ..., name: _Optional[str] = ..., content: _Optional[str] = ..., uuid: _Optional[str] = ..., version: _Optional[str] = ...) -> None: ...
